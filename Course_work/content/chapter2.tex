...
Оптимизация модели выполнялась с помощью 5-кратной кросс-валидации. Наилучшие результаты показала конфигурация с regParam=0.1, maxIter=100 и maxDepth=5, что соответствует комбинированной L1–L2 регуляризации.
